...
for ignore_file in $EXAMPLES_DIR/.sbignore*; do
    ...
    sum-buddy --input-dir "$INPUT_DIR" --output-file "$output_filepath" --ignore-file "$ignore_file" --algorithm md5
...
sum-buddy --input-dir "$INPUT_DIR" --output-file "$default_output_filepath" --algorithm md5
...
sum-buddy --input-dir "$INPUT_DIR" --output-file "$ignore_hidden_true_output_filepath" --ignore-hidden --algorithm md5
