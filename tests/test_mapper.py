...
class TestMapper(unittest.TestCase):
    ...
    def test_gather_file_paths(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            regular_files, _ = mapper.gather_file_paths(temp_dir)
            ...
            regular_files, _ = mapper.gather_file_paths(temp_dir, ignore_file=ignore_file_path)
            ...
            regular_files, _ = mapper.gather_file_paths(temp_dir, include_hidden=True)
    ...
    def test_gather_file_paths_empty(self):
        ...
        with (
            ...
            self.assertRaises(EmptyInputDirectoryError),
        ):
